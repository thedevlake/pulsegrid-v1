    ...
    <PageTransition animationType="fade">
      <div className="relative space-y-6 pb-8">
        ...
        <div className="relative z-[2]">
            ...
            <div
              className={`fixed top-4 left-4 right-4 sm:left-auto sm:right-4 sm:w-auto z-50 p-4 rounded-xl shadow-lg backdrop-blur-xl border ${
                notification.type === "success"
                  ? "bg-blue-800/20 border-blue-800/30 text-blue-400"
            ...
            >
              <div className="flex items-center space-x-2">
                ...
                <button
                  ...
                  className="ml-4 text-slate-400 hover:text-white flex-shrink-0"
                >
                  <X className="w-4 h-4" />
                </button>
              </div>
          ...
          <div className="border-b border-slate-700/50 overflow-x-auto mb-4                        ">
          ...
          {activeTab === "overview" && metrics && (
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-xl rounded-xl border border-slate-700/50 shadow-xl">
                  <div className="p-6">
            ...
            <div className="space-y-6">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center px-4 py-2 bg-blue-800 text-white text-sm font-medium rounded-xl hover:bg-blue-700 transition-all w-full sm:w-auto"
                >
              ...
              {/* Desktop Table View */}
              <div className="hidden md:block bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-xl rounded-xl border border-slate-700/50 shadow-xl overflow-hidden">
              ...
              <div className="md:hidden bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-xl rounded-xl border border-slate-700/50 shadow-xl overflow-hidden">
                <div className="divide-y divide-slate-700/50">
                  {users.map((user) => (
                    <div
                      key={user.id}
                      className="px-6 py-6 hover:bg-slate-800/40 transition-colors"
                    >
                  ...
                  {organizations.map((org) => (
                    ...
                    >
                      ...
                      <div className="text-xs text-slate-400">
                        Created: {formatDateLocale(org.created_at)}
                      </div>
                    </div>
                  ))}
                </div>
          ...
          {showCreateModal && (
            ...
            >
              <div className="flex items-center justify-center min-h-screen p-4">
                ...
                ></div>
                <div
                  className="relative bg-black/90 backdrop-blur-xl rounded-2xl border border-white/30 shadow-2xl w-full max-w-lg z-10"
                  ...
                  <form onSubmit={handleCreateUser}>
                      ...
                      <div className="space-y-3.5">
                        ...
                        {!isSuperAdmin && (
                          <div>
                            ...
                            <div className="w-full bg-white/10 border border-slate-700/50 rounded-lg py-2.5 px-4 text-slate-300">
                              {organizations.find(
                    ...
                    <div className="px-6 py-3 border-t border-white/20 bg-white/5 flex gap-3">
                      <button
                        ...
                        className="flex-1 px-4 py-2.5 rounded-lg border border-slate-700/50 bg-white/5 text-white font-medium hover:bg-white/10 transition-colors"
                      >
                        Cancel
                      </button>
                      <button
                        type="submit"
                        className="flex-1 px-4 py-2.5 rounded-lg bg-gradient-to-r from-blue-800 via-blue-800 to-blue-900 hover:from-blue-700 hover:via-blue-700 hover:to-blue-800 border border-blue-800/30 text-white font-medium transition-all duration-200 shadow-lg shadow-blue-800/50"
                      >
                        Create User
                      </button>
                    </div>
          ...
          {showEditModal && selectedUser && (
            ...
            >
              <div className="flex items-center justify-center min-h-screen p-4">
                ...
                ></div>
                <div
                  className="relative bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-xl rounded-xl text-left overflow-hidden shadow-xl w-full max-w-lg z-10 border border-slate-700/50"
                  onClick={(e) => e.stopPropagation()}
                >
                  <form onSubmit={handleEditUser}>
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <input
                            type="text"
                            required
                            className="block w-full px-4 py-2 bg-white/10 border border-slate-700/50 rounded-lg text-white placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-blue-400 transition-all"
                            value={formData.name}
                            onChange={(e) =>
                        ...
                        <div>
                          ...
                          <select
                            required
                            className="block w-full px-4 py-2 bg-white/10 border border-slate-700/50 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-blue-400 transition-all"
                            value={formData.role}
                            onChange={(e) =>
                    ...
                    <div className="px-6 py-4 bg-white/10 border-t border-white/20 flex justify-end space-x-3">
                      <button
                        ...
                        className="px-4 py-2 text-sm font-medium text-slate-300 bg-white/10 rounded-lg hover:bg-white/20 transition-colors"
                      >
                        Cancel
                      </button>
                      <button
                        type="submit"
                        className="px-4 py-2 text-sm font-medium text-white bg-blue-800 rounded-lg hover:bg-blue-700 transition-colors"
                      >
                        Update User
                      </button>
                    </div>
